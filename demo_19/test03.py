...
# ================== 配置区 ==================
class Config:
    EMBED_MODEL_PATH = r"E:\PythonNotebook\juke ai\work project\l2\day20-RAG+微调实现智能专家系统（部署测试）\day20-RAG+微调实现智能专家系统（部署测试）\demo_20\model\EMBED_MODEL"
    LLM_MODEL_PATH = r"E:\PythonNotebook\juke ai\work project\l2\day20-RAG+微调实现智能专家系统（部署测试）\day20-RAG+微调实现智能专家系统（部署测试）\demo_20\model\LLM_MODEL"
    
    DATA_DIR = r"E:\PythonNotebook\juke ai\work project\l2\day19-RAG+微调实现智能专家系统（方案数据篇）\day19-RAG+微调实现智能专家系统（方案数据篇）\demo_19\data02"
